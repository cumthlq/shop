...
//		this.addActionError(order.getTotal()+"");
		return "saveOrder";
	}
...
//		currOrder.setName(order.getName());
//		currOrder.setPhone(order.getPhone());
//		currOrder.setTotal(order.getTotal());
		
		orderService.update(order);
		this.addActionMessage("支付成功!订单编号为: "+order.getOid()+",總金額為:"+order.getTotal());
//		return "msg";
		return "msg";
		// 2.完成付款:
		// 付款需要的参数:
